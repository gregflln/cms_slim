...
<div class="flex gap-3 items-center justify-start">
    <a class="flex items-center justify-center font-semibold rounded-lg bg-blue-500 text-white p-5 hover:bg-blue-400" href="/rendezvous/create/<?= $data["beneficiaire"]["id"] ?>">nouveau rendez vous</a>
    <a class="flex items-center justify-center font-semibold rounded-lg bg-green-500 text-white p-5 hover:bg-green-400" href="/visites/create/<?= $data["beneficiaire"]["id"] ?>">nouvelle visite</a>
</div>
